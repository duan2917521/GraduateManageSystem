...
public class xxAdd extends JDialog implements ActionListener{
  //=========面板控件
  //......左侧标题栏
  ...
  //构造函数
  public xxAdd(Frame owner, String title, boolean modal) 
  {
    //========重写父类方法
  ...
  public void actionPerformed(ActionEvent e) 
  {
    ...
    if(e.getActionCommand().equals("add")) {
      ...
      String sql = "insert into 学校管理 values(?)";
      String []paras = {idTxt.getText()};
      if(!tmp.cudStu(sql, paras))
        JOptionPane.showMessageDialog(this, "添加学校失败");
      //========关闭窗口
      this.dispose();
