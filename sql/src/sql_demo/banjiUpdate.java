...
public class banjiUpdate extends JDialog implements ActionListener{
  //=========面板控件
  //......左侧标题栏
	  //......左侧标题栏
  ...
  //构造函数
  public banjiUpdate(Frame owner, String title, boolean modal, banjiModel sm, int  rowNum) 
  {
    //========重写父类方法
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    /***********************修改学生信息**************************/
      ...
      String sql = "update 班级管理 set 班级=?";
      String []paras = {idTxt.getText(),
    		 };
      if(!tmp.cudStu(sql, paras))
        JOptionPane.showMessageDialog(this, "修改班级信息失败");
      //========关闭窗口
      this.dispose();
