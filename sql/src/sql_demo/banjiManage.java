...
//import cn.com.*;
public class banjiManage extends JFrame implements ActionListener {
  //========面板控件
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    //} 
     if(e.getActionCommand().equals("add")) {
      ...
      //========获取学生ID号
      String 班级 = (String)sm.getValueAt(rowNum, 0);
      //========删除学生
      String sql = "delete from 班级管理 where 班级=?";
      String []paras = {班级};
      banjiModel tmp = new banjiModel();
      tmp.cudStu(sql, paras);
      //========更新模型
      sql = "select * from 班级管理";
      jtableUpdate(sql, null);
    } 
  }
