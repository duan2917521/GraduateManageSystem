  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    //} 
     if(e.getActionCommand().equals("add")) {
      ...
      //========获取学生ID号
      String 序号 = (String)sm.getValueAt(rowNum, 0);
      //========删除学生
      String sql = "delete from 学校管理 where 序号=?";
      String []paras = {序号};
      xxModel tmp = new xxModel();
      tmp.cudStu(sql, paras);
      //========更新模型
      sql = "select * from 学校管理";
      jtableUpdate(sql, null);
    }
        ...
        new xxUp(this, "修改学校信息", true, sm, rowNum);
        String sql = "select * from 学校管理";
        jtableUpdate(sql, null);
    }
  }
