...
public class liuYanManage extends JFrame implements ActionListener {
  //========面板控件
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if(e.getActionCommand().equals("query")) {
      ...
      if(name.length() != 0) {
        //========姓名输入有效时，执行查询
        //......定义参数
        String sql = "select * from 留言 where 姓名=?";
        String []paras = {name};
        //......更新模型
    ...
    //}
      ...
      //========删除学生
      String sql = "delete from 留言 where 编号=?";
      String []paras = {编号};
    ...
    //else if(e.getActionCommand().equals("update")) {
      ...
      //if(rowNum == -1) {
        ...
        //return ;
      //}
      //new liuYanUpdateDialog(this, "学生留言情况查看与修改", true, sm, rowNum);
      //String sql = "select * from 留言 ";
      //jtableUpdate(sql, null);
    //}
  }
