...
//import cn.com.*;
public class ZhuanYeManage extends JFrame implements ActionListener {
  //========面板控件
  ...
  //========
  private ZhuanyeModel sm = null;
  
  //构造函数
  public ZhuanYeManage()
  {
    /***************************初始化面板控件***********************/
    //========查询栏
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    //} 
     if(e.getActionCommand().equals("add")) {
      /*********************添加***********************/
      new ZhunyeAddDialog(this, "添加专业信息", true);
      String sql = "select * from 专业管理";
      ...
      //========获取学生ID号
      String 专业 = (String)sm.getValueAt(rowNum, 0);
      //========删除学生
      String sql = "delete from 专业管理 where 专业=?";
      String []paras = {专业};
      ZhuanyeModel tmp = new ZhuanyeModel();
      tmp.cudStu(sql, paras);
      //========更新模型
      sql = "select * from 专业管理";
      jtableUpdate(sql, null);
      ...
      new ZhuanYeUpdate(this, "修改专业信息", true, sm, rowNum);
      String sql = "select * from 专业管理";
      jtableUpdate(sql, null);
    }
  }
