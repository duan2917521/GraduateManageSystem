...
public class timeAdd extends JDialog implements ActionListener{
  //=========面板控件
  //......左侧标题栏
  ...
  //构造函数
  public timeAdd(Frame owner, String title, boolean modal) 
  {
    //========重写父类方法
  ...
  public void actionPerformed(ActionEvent e) 
  {
    ...
    if(e.getActionCommand().equals("add")) {
      ...
      String sql = "insert into 毕业年月管理 values(?)";
